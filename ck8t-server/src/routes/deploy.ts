...
export default async function (app: FastifyInstance) {
  ...
  //                - http://ck8t-server:3001/ck8t/scheduler/start
  //              restartPolicy: Never
  //          backoffLimit: 1
  //
  // ────────────────────────────────────────────────────────────────
  app.post(
    '/ck8t/scheduler/start',
  ...
  // ── Deploy a workflow ──────────────────────────────────────────
  app.post('/ck8t/deploy', async (req: FastifyRequest<{ Body: DeployBody }>, reply) => {
    try {
  ...
  // ── Undeploy a workflow ────────────────────────────────────────
  app.post('/ck8t/undeploy', async (req: FastifyRequest<{ Body: UndeployBody }>, reply) => {
    try {
  ...
  app.get('/ck8t/deployments', async (_req, reply) => {
    const scheduler = getScheduler()
