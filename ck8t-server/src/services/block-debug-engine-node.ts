 ...
 *
 * Keep in sync with the other copy at
 * extension/vscode/ck8t/src/services/block-debug-engine-node.ts (same pattern this project
 * already uses for graph-runner.ts being duplicated across the 3 execution engines).
 *
 ...
 *     Node 16+, confirmed present on this server's Node 22 runtime) rather than importing
 *     the browser ESM file directly.
 */
