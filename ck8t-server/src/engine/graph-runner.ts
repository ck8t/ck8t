...
async function runNode(opts: {
  ...
  switch (blockType) {
    ...
    case 'for_loop':
      throw new Error('For Loop block: loop expansion is not yet implemented in ck8t-server.');
    case 'for_each':
      throw new Error('For Each block: loop iteration is not yet implemented in ck8t-server.');
    ...
    case 'slack':
      throw new Error('Slack block: not yet implemented in ck8t-server. Configure SLACK_BOT_TOKEN and add the Slack connector.');

    case 'smtp':
      throw new Error('SMTP block: not yet implemented in ck8t-server. Configure SMTP_HOST, SMTP_USER, SMTP_PASS environment variables.');

    case 'postgresql':
      throw new Error('PostgreSQL block: not yet implemented in ck8t-server. Configure DATABASE_URL environment variable.');

    case 'redis':
      throw new Error('Redis block: not yet implemented in ck8t-server. Configure REDIS_URL environment variable.');

    case 'mongodb':
      throw new Error('MongoDB block: not yet implemented in ck8t-server. Configure MONGODB_URI environment variable.');
    ...
    case 'parallel':
      throw new Error('Parallel block: parallel branch execution is not yet implemented in ck8t-server.');
    case 'table':
      throw new Error('Table block: requires database connection configuration in ck8t-server.');
    case 'mapper':
