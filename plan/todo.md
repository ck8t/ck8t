...
> Last Modified: June 18, 2026 (graph analysis: 989 nodes · 2,010 edges · 59 communities)
...
| 6.2 | Step-by-step debug mode | ❌ | Run | "Debug" run pauses after each block, shows intermediate values, manual "Continue" | `run/`, `AgentBuilderPage.jsx` |
