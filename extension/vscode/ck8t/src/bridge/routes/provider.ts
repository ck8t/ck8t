...
export function providerRouter() {
  ...
  /* GET /api/v1/ck8t/llm/providers */
  router.get('/ck8t/llm/providers', async (_req: Request, res: Response) => {
    try {
  ...
  /* GET /api/v1/ck8t/llm/custom-providers */
  router.get('/ck8t/llm/custom-providers', (_req: Request, res: Response) => {
    try {
  ...
  /* POST /api/v1/ck8t/llm/custom-providers — create or update */
  router.post('/ck8t/llm/custom-providers', async (req: Request, res: Response) => {
    try {
  ...
  /* POST /api/v1/ck8t/llm/custom-providers/:key/models — refresh model list */
  router.post(
