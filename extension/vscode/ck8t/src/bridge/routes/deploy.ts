...
export function deployRouter() {
  ...
  /* POST /api/v1/ck8t/deploy */
  router.post('/ck8t/deploy', (req: Request, res: Response) => {
    try {
  ...
  /* POST /api/v1/ck8t/undeploy */
  router.post('/ck8t/undeploy', (req: Request, res: Response) => {
    try {
  ...
  /* GET /api/v1/ck8t/deployments */
  router.get('/ck8t/deployments', (_req: Request, res: Response) => {
    res.json({ deployments: scheduler.listDeployments() });
  });

  /* POST /api/v1/ck8t/scheduler/start — manual / AKS-style trigger */
  router.post('/ck8t/scheduler/start', async (req: Request, res: Response) => {
    try {
  ...
  /* POST /api/v1/ck8t/execute/:workflowId */
  router.post('/ck8t/execute/:workflowId', async (req: Request, res: Response) => {
    try {
