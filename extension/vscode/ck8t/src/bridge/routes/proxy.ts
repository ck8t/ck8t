...
export function proxyRouter() {
  ...
  router.get('/ck8t/proxy', async (req: Request, res: Response) => {
  ...
  router.post('/ck8t/proxy', async (req: Request, res: Response) => {
