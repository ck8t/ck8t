 ...
 *   /api/v1/ck8t/llm/providers  → static Copilot model list
 *   /api/v1/ck8t/llm/provider   → update active family
 *   /api/v1/ck8t/deploy         → scheduler.ts
 *   /api/v1/ck8t/undeploy       → scheduler.ts
 *   /api/v1/ck8t/deployments    → scheduler.ts
...
export function stopBridgeServer() {
  if (_server) {
    _server.close();
    _server = null;
    console.log('[ck8t] Bridge server stopped');
  }
}
